import { EnterpriseMoveManagementService } from '../../src/services/real-world-scenarios/EnterpriseMoveManagementService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('EnterpriseMoveManagementService', () => {
  let service: EnterpriseMoveManagementService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new EnterpriseMoveManagementService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(EnterpriseMoveManagementService);
    });
