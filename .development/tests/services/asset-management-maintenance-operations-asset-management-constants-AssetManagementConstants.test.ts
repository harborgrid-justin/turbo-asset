import { AssetManagementConstants } from '../../src/services/asset-management/maintenance-operations/asset-management/constants/AssetManagementConstants';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('AssetManagementConstants', () => {
  let service: AssetManagementConstants;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new AssetManagementConstants();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(AssetManagementConstants);
    });
