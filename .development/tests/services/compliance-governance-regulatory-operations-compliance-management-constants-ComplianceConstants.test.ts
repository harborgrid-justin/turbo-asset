import { ComplianceConstants } from '../../src/services/compliance-governance/regulatory-operations/compliance-management/constants/ComplianceConstants';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('ComplianceConstants', () => {
  let service: ComplianceConstants;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new ComplianceConstants();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(ComplianceConstants);
    });
