import { AssetCreateService } from '../../src/services/asset-management/maintenance-operations/asset-management/AssetCreateService';
...
describe('AssetCreateService', () => {
  ...
  beforeEach(async () => {
    service = new AssetCreateService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(AssetCreateService);
    });
