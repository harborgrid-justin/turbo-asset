import { MoveManagementService } from '../../src/services/space/MoveManagementService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('MoveManagementService', () => {
  let service: MoveManagementService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(MoveManagementService);
    });
