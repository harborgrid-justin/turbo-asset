import { SpaceUtilizationAnalyticsService } from '../../src/services/space-management/utilization-analytics/space-operations/SpaceUtilizationAnalyticsService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('SpaceUtilizationAnalyticsService', () => {
  let service: SpaceUtilizationAnalyticsService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new SpaceUtilizationAnalyticsService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(SpaceUtilizationAnalyticsService);
    });
