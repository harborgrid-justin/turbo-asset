import { advancedMlIntegration } from '../../src/services/advanced-ml-integration';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('advancedMlIntegration', () => {
  let service: advancedMlIntegration;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new advancedMlIntegration();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(advancedMlIntegration);
    });
