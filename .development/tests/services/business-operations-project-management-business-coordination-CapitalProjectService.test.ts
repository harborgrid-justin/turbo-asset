import { CapitalProjectService } from '../../src/services/business-operations/project-management/business-coordination/CapitalProjectService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('CapitalProjectService', () => {
  let service: CapitalProjectService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(CapitalProjectService);
    });
