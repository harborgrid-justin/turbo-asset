import { ChargebackAllocationService } from '../../src/services/financial-management/cost-accounting/financial-operations/ChargebackAllocationService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('ChargebackAllocationService', () => {
  let service: ChargebackAllocationService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new ChargebackAllocationService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(ChargebackAllocationService);
    });
