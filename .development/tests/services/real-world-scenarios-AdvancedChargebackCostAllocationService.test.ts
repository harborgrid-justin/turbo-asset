import { AdvancedChargebackCostAllocationService } from '../../src/services/real-world-scenarios/AdvancedChargebackCostAllocationService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('AdvancedChargebackCostAllocationService', () => {
  let service: AdvancedChargebackCostAllocationService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new AdvancedChargebackCostAllocationService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(AdvancedChargebackCostAllocationService);
    });
