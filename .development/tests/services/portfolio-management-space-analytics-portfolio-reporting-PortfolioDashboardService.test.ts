import { PortfolioDashboardService } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/PortfolioDashboardService';
...
describe('PortfolioDashboardService', () => {
  ...
  beforeEach(async () => {
    service = new PortfolioDashboardService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioDashboardService);
    });
