import { PortfolioReportingConstants } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/constants/PortfolioReportingConstants';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('PortfolioReportingConstants', () => {
  let service: PortfolioReportingConstants;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new PortfolioReportingConstants();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioReportingConstants);
    });
