import { DocumentPermissionService } from '../../src/services/document-management/content-operations/document-lifecycle/DocumentPermissionService';
...
describe('DocumentPermissionService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(DocumentPermissionService);
    });
