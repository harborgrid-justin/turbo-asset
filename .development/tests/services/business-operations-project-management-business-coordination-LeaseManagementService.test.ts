import { LeaseManagementService } from '../../src/services/business-operations/project-management/business-coordination/LeaseManagementService';
...
describe('LeaseManagementService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(LeaseManagementService);
    });
