import { PortfolioDataExportService } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/PortfolioDataExportService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('PortfolioDataExportService', () => {
  let service: PortfolioDataExportService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new PortfolioDataExportService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioDataExportService);
    });
