import { InfrastructureConstants } from '../../src/services/infrastructure-technology/smart-systems/infrastructure-operations/constants/InfrastructureConstants';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('InfrastructureConstants', () => {
  let service: InfrastructureConstants;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new InfrastructureConstants();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(InfrastructureConstants);
    });
