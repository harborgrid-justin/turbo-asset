import { CorporateRealEstateManagementService } from '../../src/services/real-world-scenarios/CorporateRealEstateManagementService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('CorporateRealEstateManagementService', () => {
  let service: CorporateRealEstateManagementService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new CorporateRealEstateManagementService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(CorporateRealEstateManagementService);
    });
