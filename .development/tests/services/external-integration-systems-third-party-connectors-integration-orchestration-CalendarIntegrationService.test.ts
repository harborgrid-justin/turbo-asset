import { CalendarIntegrationService } from '../../src/services/external-integration-systems/third-party-connectors/integration-orchestration/CalendarIntegrationService';
...
describe('CalendarIntegrationService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(CalendarIntegrationService);
    });
