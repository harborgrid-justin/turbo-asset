import { CustomFieldManagementService } from '../../src/services/tenant-management/branding-operations/tenant-branding/CustomFieldManagementService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('CustomFieldManagementService', () => {
  let service: CustomFieldManagementService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new CustomFieldManagementService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(CustomFieldManagementService);
    });
