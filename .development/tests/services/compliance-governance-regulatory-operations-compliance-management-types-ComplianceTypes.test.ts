import { ComplianceTypes } from '../../src/services/compliance-governance/regulatory-operations/compliance-management/types/ComplianceTypes';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('ComplianceTypes', () => {
  let service: ComplianceTypes;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new ComplianceTypes();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(ComplianceTypes);
    });
