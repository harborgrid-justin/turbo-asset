import { DocumentTypes } from '../../src/services/document-management/content-operations/document-lifecycle/types/DocumentTypes';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('DocumentTypes', () => {
  let service: DocumentTypes;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new DocumentTypes();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(DocumentTypes);
    });
