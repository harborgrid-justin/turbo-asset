import { PortfolioVisualizationService } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/PortfolioVisualizationService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('PortfolioVisualizationService', () => {
  let service: PortfolioVisualizationService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new PortfolioVisualizationService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioVisualizationService);
    });
