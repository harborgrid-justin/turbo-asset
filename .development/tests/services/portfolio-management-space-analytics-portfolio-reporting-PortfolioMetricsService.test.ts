import { PortfolioMetricsService } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/PortfolioMetricsService';
...
describe('PortfolioMetricsService', () => {
  ...
  beforeEach(async () => {
    service = new PortfolioMetricsService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioMetricsService);
    });
