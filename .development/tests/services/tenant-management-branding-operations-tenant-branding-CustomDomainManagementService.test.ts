import { CustomDomainManagementService } from '../../src/services/tenant-management/branding-operations/tenant-branding/CustomDomainManagementService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('CustomDomainManagementService', () => {
  let service: CustomDomainManagementService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new CustomDomainManagementService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(CustomDomainManagementService);
    });
