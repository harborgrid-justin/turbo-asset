import { BudgetForecastService } from '../../src/services/financial-management/cost-accounting/financial-operations/BudgetForecastService';
...
describe('BudgetForecastService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(BudgetForecastService);
    });
