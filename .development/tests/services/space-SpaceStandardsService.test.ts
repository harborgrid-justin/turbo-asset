import { SpaceStandardsService } from '../../src/services/space/SpaceStandardsService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('SpaceStandardsService', () => {
  let service: SpaceStandardsService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(SpaceStandardsService);
    });
