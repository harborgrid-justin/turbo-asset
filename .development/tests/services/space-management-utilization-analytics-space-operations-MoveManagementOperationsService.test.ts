import { MoveManagementOperationsService } from '../../src/services/space-management/utilization-analytics/space-operations/MoveManagementOperationsService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('MoveManagementOperationsService', () => {
  let service: MoveManagementOperationsService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new MoveManagementOperationsService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(MoveManagementOperationsService);
    });
