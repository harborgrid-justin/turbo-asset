import { EnergyManagementService } from '../../src/services/infrastructure-technology/smart-systems/infrastructure-operations/EnergyManagementService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('EnergyManagementService', () => {
  let service: EnergyManagementService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(EnergyManagementService);
    });
