import { VendorBrokerService } from '../../src/services/business-operations/project-management/business-coordination/VendorBrokerService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('VendorBrokerService', () => {
  let service: VendorBrokerService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(VendorBrokerService);
    });
