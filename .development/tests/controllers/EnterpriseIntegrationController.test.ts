...
import EnterpriseIntegrationController from '../../src/controllers/EnterpriseIntegrationController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/enterpriseintegration', EnterpriseIntegrationController);

describe('EnterpriseIntegrationController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/enterpriseintegration');
    ...
    it('should handle PUT requests for updates', async () => {
      ...
      const response = await request(app)
        .put('/enterpriseintegration/test-id')
        .send(updateData);
    ...
    it('should handle DELETE requests', async () => {
      const response = await request(app)
        .delete('/enterpriseintegration/test-id');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/enterpriseintegration/non-existent-id');
