...
import LeaseManagementController from '../../src/controllers/LeaseManagementController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/leasemanagement', LeaseManagementController);

describe('LeaseManagementController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/leasemanagement');
    ...
    it('should handle DELETE requests', async () => {
      const response = await request(app)
        .delete('/leasemanagement/test-id');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/leasemanagement/non-existent-id');
