...
import SpaceAnalyticsController from '../../src/controllers/SpaceAnalyticsController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/spaceanalytics', SpaceAnalyticsController);

describe('SpaceAnalyticsController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/spaceanalytics');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/spaceanalytics/non-existent-id');
