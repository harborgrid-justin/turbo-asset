...
import CriticalDateController from '../../src/controllers/CriticalDateController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/criticaldate', CriticalDateController);

describe('CriticalDateController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/criticaldate');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/criticaldate/non-existent-id');
