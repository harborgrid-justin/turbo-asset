...
import BusinessIntelligenceController from '../../src/controllers/BusinessIntelligenceController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/businessintelligence', BusinessIntelligenceController);
...
describe('BusinessIntelligenceController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/businessintelligence');
    ...
    it('should handle PUT requests for updates', async () => {
      ...
      const response = await request(app)
        .put('/businessintelligence/test-id')
        .send(updateData);
    ...
    it('should handle DELETE requests', async () => {
      const response = await request(app)
        .delete('/businessintelligence/test-id');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/businessintelligence/non-existent-id');
