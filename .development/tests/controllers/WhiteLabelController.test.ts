...
import WhiteLabelController from '../../src/controllers/WhiteLabelController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/whitelabel', WhiteLabelController);
...
describe('WhiteLabelController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/whitelabel');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/whitelabel/non-existent-id');
