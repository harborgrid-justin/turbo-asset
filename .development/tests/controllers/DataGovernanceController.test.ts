...
import DataGovernanceController from '../../src/controllers/DataGovernanceController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/datagovernance', DataGovernanceController);
...
describe('DataGovernanceController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/datagovernance');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/datagovernance/non-existent-id');
