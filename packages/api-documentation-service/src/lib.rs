...
#[napi]
pub struct ApiDocumentationServiceService {
  // Service implementation
}

#[napi]
impl ApiDocumentationServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "api-documentation-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "API documentation generation and management".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("ApiDocumentationServiceService initialized successfully".to_string())
}