...
/// Automated API documentation generation and management service
#[napi]
...
impl ApiDocumentation {
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "api-documentation-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "api-documentation-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Automated API documentation generation and management service".to_string());
    info.insert("features".to_string(), "OpenAPI generation, documentation automation, SDK generation, API versioning".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("ApiDocumentation initialized successfully".to_string())
}