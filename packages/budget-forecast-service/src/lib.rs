...
/// Financial budgeting and forecasting service with predictive modeling
#[napi]
...
impl BudgetForecast {
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "budget-forecast-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "budget-forecast-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Financial budgeting and forecasting service with predictive modeling".to_string());
    info.insert("features".to_string(), "budget planning, financial forecasting, variance analysis, cost modeling".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("BudgetForecast initialized successfully".to_string())
}