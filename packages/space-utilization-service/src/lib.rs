...
/// Space utilization analytics and optimization service
#[napi]
pub struct SpaceUtilizationService {
  // Service implementation
}

#[napi]
impl SpaceUtilizationService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "space-utilization-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Space utilization analytics and optimization service".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("SpaceUtilizationService initialized successfully".to_string())
}