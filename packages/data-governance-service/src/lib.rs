...
#[napi]
pub struct DataGovernanceServiceService {
  // Service implementation
}

#[napi]
impl DataGovernanceServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "data-governance-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Data governance and quality management".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("DataGovernanceServiceService initialized successfully".to_string())
}