...
#[napi]
pub struct IntegrationServiceService {
  // Service implementation
}

#[napi]
impl IntegrationServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "integration-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "System integration orchestration and management".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("IntegrationServiceService initialized successfully".to_string())
}