...
/// Emergency response planning and disaster recovery service
#[napi]
pub struct EmergencyPlanning {
  // Service implementation
}

#[napi]
impl EmergencyPlanning {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "emergency-planning-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "emergency-planning-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Emergency response planning and disaster recovery service".to_string());
    info.insert("features".to_string(), "emergency protocols, disaster recovery, response coordination, safety management".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("EmergencyPlanning initialized successfully".to_string())
}