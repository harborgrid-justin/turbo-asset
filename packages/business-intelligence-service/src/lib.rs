...
#[napi]
pub struct BusinessIntelligenceServiceService {
  // Service implementation
}

#[napi]
impl BusinessIntelligenceServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "business-intelligence-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Business intelligence and advanced analytics".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("BusinessIntelligenceServiceService initialized successfully".to_string())
}