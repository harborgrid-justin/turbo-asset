...
#[napi]
pub struct AssetLifecycleServiceService {
  // Service implementation
}

#[napi]
impl AssetLifecycleServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "asset-lifecycle-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Comprehensive asset lifecycle management".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("AssetLifecycleServiceService initialized successfully".to_string())
}