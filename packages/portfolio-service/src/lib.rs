...
impl PortfolioService {
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("description".to_string(), "Portfolio analytics and performance tracking service".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("PortfolioService initialized successfully".to_string())
}