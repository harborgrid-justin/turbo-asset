...
#[napi]
pub struct TechnicianMobileServiceService {
  // Service implementation
}

#[napi]
impl TechnicianMobileServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "technician-mobile-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Mobile technician operations and field service".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("TechnicianMobileServiceService initialized successfully".to_string())
}