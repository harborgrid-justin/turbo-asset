...
/// Vendor and broker relationship management service
#[napi]
pub struct VendorBroker {
...
impl VendorBroker {
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "vendor-broker-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "vendor-broker-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Vendor and broker relationship management service".to_string());
    info.insert("features".to_string(), "vendor management, broker relations, performance tracking, contract negotiation".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("VendorBroker initialized successfully".to_string())
}