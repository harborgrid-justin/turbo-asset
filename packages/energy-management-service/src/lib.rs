...
#[napi]
pub struct EnergyManagementServiceService {
  // Service implementation
}

#[napi]
impl EnergyManagementServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "energy-management-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Energy monitoring and management system".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("EnergyManagementServiceService initialized successfully".to_string())
}