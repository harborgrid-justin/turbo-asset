...
#[napi]
pub struct DataWarehouseServiceService {
  // Service implementation
}

#[napi]
impl DataWarehouseServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "data-warehouse-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Data warehousing and ETL operations".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("DataWarehouseServiceService initialized successfully".to_string())
}