...
#[napi]
pub struct CalendarIntegrationServiceService {
  // Service implementation
}

#[napi]
impl CalendarIntegrationServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "calendar-integration-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Calendar system integration and synchronization".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("CalendarIntegrationServiceService initialized successfully".to_string())
}