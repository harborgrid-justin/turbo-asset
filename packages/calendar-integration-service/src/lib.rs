...
/// Multi-platform calendar integration and scheduling service
#[napi]
...
impl CalendarIntegration {
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "calendar-integration-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "calendar-integration-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Multi-platform calendar integration and scheduling service".to_string());
    info.insert("features".to_string(), "calendar sync, event management, scheduling optimization, availability tracking".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("CalendarIntegration initialized successfully".to_string())
}