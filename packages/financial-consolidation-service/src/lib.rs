...
/// Financial data consolidation and reporting service
#[napi]
pub struct FinancialConsolidation {
  // Service implementation
}

#[napi]
impl FinancialConsolidation {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "financial-consolidation-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "financial-consolidation-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Financial data consolidation and reporting service".to_string());
    info.insert("features".to_string(), "financial consolidation, multi-entity reporting, currency conversion, regulatory reporting".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("FinancialConsolidation initialized successfully".to_string())
}