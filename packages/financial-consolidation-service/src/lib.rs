...
#[napi]
pub struct FinancialConsolidationServiceService {
  // Service implementation
}

#[napi]
impl FinancialConsolidationServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "financial-consolidation-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Financial data consolidation and reporting".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("FinancialConsolidationServiceService initialized successfully".to_string())
}