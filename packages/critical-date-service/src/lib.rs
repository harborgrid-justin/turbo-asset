...
/// Critical date monitoring and alert management service
#[napi]
...
impl CriticalDate {
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "critical-date-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "critical-date-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Critical date monitoring and alert management service".to_string());
    info.insert("features".to_string(), "deadline tracking, alert management, escalation workflows, notification routing".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("CriticalDate initialized successfully".to_string())
}