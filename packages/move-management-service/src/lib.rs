...
/// Employee and asset relocation management service
#[napi]
pub struct MoveManagement {
...
impl MoveManagement {
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "move-management-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "move-management-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Employee and asset relocation management service".to_string());
    info.insert("features".to_string(), "move planning, resource allocation, logistics coordination, cost tracking".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("MoveManagement initialized successfully".to_string())
}