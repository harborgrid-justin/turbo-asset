...
#[napi]
pub struct ComplianceServiceService {
  // Service implementation
}

#[napi]
impl ComplianceServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "compliance-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Regulatory compliance management and monitoring".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("ComplianceServiceService initialized successfully".to_string())
}