...
#[napi]
pub struct ReportingServiceService {
  // Service implementation
}

#[napi]
impl ReportingServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "reporting-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Report generation and business intelligence service".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("ReportingServiceService initialized successfully".to_string())
}