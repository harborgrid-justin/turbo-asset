...
/// Multi-language SDK and code generation service
#[napi]
...
impl SdkGenerator {
  ...
  pub fn health_check(&self) -> Result<HashMap<String, String>> {
    ...
    health.insert("service".to_string(), "sdk-generator-service".to_string());
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "sdk-generator-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "Multi-language SDK and code generation service".to_string());
    info.insert("features".to_string(), "SDK generation, code templates, multi-language support, documentation generation".to_string());
    Ok(info)
  }
...
pub fn init() -> Result<String> {
  Ok("SdkGenerator initialized successfully".to_string())
}