...
#[napi]
pub struct SdkGeneratorServiceService {
  // Service implementation
}

#[napi]
impl SdkGeneratorServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "sdk-generator-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "SDK generation and developer tools".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("SdkGeneratorServiceService initialized successfully".to_string())
}