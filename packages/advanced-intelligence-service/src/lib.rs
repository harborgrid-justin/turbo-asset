...
#[napi]
pub struct AdvancedIntelligenceServiceService {
  // Service implementation
}

#[napi]
impl AdvancedIntelligenceServiceService {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {}
  }
  ...
  pub fn get_service_info(&self) -> Result<HashMap<String, String>> {
    ...
    info.insert("name".to_string(), "advanced-intelligence-service-service".to_string());
    info.insert("version".to_string(), "1.0.0".to_string());
    info.insert("description".to_string(), "AI/ML intelligence and predictive analytics".to_string());
    Ok(info)
  }
}
...
pub fn init() -> Result<String> {
  Ok("AdvancedIntelligenceServiceService initialized successfully".to_string())
}