...
import DataWarehouseController from '../../src/controllers/DataWarehouseController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/datawarehouse', DataWarehouseController);

describe('DataWarehouseController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/datawarehouse');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/datawarehouse/non-existent-id');
