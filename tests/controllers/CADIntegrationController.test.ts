...
import CADIntegrationController from '../../src/controllers/CADIntegrationController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/cadintegration', CADIntegrationController);

describe('CADIntegrationController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/cadintegration');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/cadintegration/non-existent-id');
