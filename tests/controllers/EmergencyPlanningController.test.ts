...
import EmergencyPlanningController from '../../src/controllers/EmergencyPlanningController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/emergencyplanning', EmergencyPlanningController);

describe('EmergencyPlanningController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/emergencyplanning');
    ...
    it('should handle DELETE requests', async () => {
      const response = await request(app)
        .delete('/emergencyplanning/test-id');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/emergencyplanning/non-existent-id');
