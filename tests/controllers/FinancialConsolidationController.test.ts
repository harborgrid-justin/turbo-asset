...
import FinancialConsolidationController from '../../src/controllers/FinancialConsolidationController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/financialconsolidation', FinancialConsolidationController);

describe('FinancialConsolidationController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/financialconsolidation');
    ...
    it('should handle PUT requests for updates', async () => {
      ...
      const response = await request(app)
        .put('/financialconsolidation/test-id')
        .send(updateData);
    ...
    it('should handle DELETE requests', async () => {
      const response = await request(app)
        .delete('/financialconsolidation/test-id');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/financialconsolidation/non-existent-id');
