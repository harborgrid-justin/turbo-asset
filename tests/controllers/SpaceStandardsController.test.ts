...
import SpaceStandardsController from '../../src/controllers/SpaceStandardsController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/spacestandards', SpaceStandardsController);

describe('SpaceStandardsController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/spacestandards');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/spacestandards/non-existent-id');
