...
import MoveManagementController from '../../src/controllers/MoveManagementController';
import { createTestOrganization, createTestUser, testDb } from '../setup';

const app = express();
app.use(express.json());
app.use('/movemanagement', MoveManagementController);

describe('MoveManagementController', () => {
  ...
  describe('HTTP Endpoints', () => {
    it('should handle GET requests', async () => {
      const response = await request(app).get('/movemanagement');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle not found scenarios', async () => {
      const response = await request(app)
        .get('/movemanagement/non-existent-id');
