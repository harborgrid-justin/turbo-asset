import { PortfolioAlertService } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/PortfolioAlertService';
...
describe('PortfolioAlertService', () => {
  ...
  beforeEach(async () => {
    service = new PortfolioAlertService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioAlertService);
    });
