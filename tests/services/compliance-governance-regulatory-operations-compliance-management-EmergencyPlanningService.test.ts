import { EmergencyPlanningService } from '../../src/services/compliance-governance/regulatory-operations/compliance-management/EmergencyPlanningService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('EmergencyPlanningService', () => {
  let service: EmergencyPlanningService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(EmergencyPlanningService);
    });
