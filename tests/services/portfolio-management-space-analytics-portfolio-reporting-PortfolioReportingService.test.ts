import { PortfolioReportingService } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/PortfolioReportingService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('PortfolioReportingService', () => {
  let service: PortfolioReportingService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new PortfolioReportingService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioReportingService);
    });
