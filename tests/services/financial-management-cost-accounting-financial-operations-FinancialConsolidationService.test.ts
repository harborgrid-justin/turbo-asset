import { FinancialConsolidationService } from '../../src/services/financial-management/cost-accounting/financial-operations/FinancialConsolidationService';
...
describe('FinancialConsolidationService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(FinancialConsolidationService);
    });
