import { IoTDeviceManagementService } from '../../src/services/infrastructure-technology/smart-systems/infrastructure-operations/IoTDeviceManagementService';
...
describe('IoTDeviceManagementService', () => {
  ...
  beforeEach(async () => {
    service = new IoTDeviceManagementService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(IoTDeviceManagementService);
    });
