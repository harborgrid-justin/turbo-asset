import { CAMReconciliationService } from '../../src/services/business-operations/project-management/business-coordination/CAMReconciliationService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('CAMReconciliationService', () => {
  let service: CAMReconciliationService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new CAMReconciliationService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(CAMReconciliationService);
    });
