import { ContractLifecycleService } from '../../src/services/business-operations/project-management/business-coordination/ContractLifecycleService';
...
describe('ContractLifecycleService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(ContractLifecycleService);
    });
