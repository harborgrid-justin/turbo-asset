import { PortfolioFinancialAnalysisService } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/PortfolioFinancialAnalysisService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('PortfolioFinancialAnalysisService', () => {
  let service: PortfolioFinancialAnalysisService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new PortfolioFinancialAnalysisService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioFinancialAnalysisService);
    });
