import { BusinessOperationsReportsService } from '../../src/services/business-operations/project-management/business-coordination/BusinessOperationsReportsService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('BusinessOperationsReportsService', () => {
  let service: BusinessOperationsReportsService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new BusinessOperationsReportsService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(BusinessOperationsReportsService);
    });
