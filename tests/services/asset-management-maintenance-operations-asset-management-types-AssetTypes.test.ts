import { AssetTypes } from '../../src/services/asset-management/maintenance-operations/asset-management/types/AssetTypes';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('AssetTypes', () => {
  let service: AssetTypes;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new AssetTypes();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(AssetTypes);
    });
