import { AssetImportExportService } from '../../src/services/asset-management/maintenance-operations/asset-management/AssetImportExportService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('AssetImportExportService', () => {
  let service: AssetImportExportService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new AssetImportExportService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(AssetImportExportService);
    });
