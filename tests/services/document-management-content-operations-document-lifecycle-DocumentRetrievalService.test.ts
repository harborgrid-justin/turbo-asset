import { DocumentRetrievalService } from '../../src/services/document-management/content-operations/document-lifecycle/DocumentRetrievalService';
...
describe('DocumentRetrievalService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(DocumentRetrievalService);
    });
