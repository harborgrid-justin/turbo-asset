import { CriticalDateService } from '../../src/services/business-operations/project-management/business-coordination/CriticalDateService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('CriticalDateService', () => {
  let service: CriticalDateService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(CriticalDateService);
    });
