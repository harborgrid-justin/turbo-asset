import { PortfolioReportingTypes } from '../../src/services/portfolio-management/space-analytics/portfolio-reporting/types/PortfolioReportingTypes';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('PortfolioReportingTypes', () => {
  let service: PortfolioReportingTypes;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new PortfolioReportingTypes();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(PortfolioReportingTypes);
    });
