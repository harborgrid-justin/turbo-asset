import { Microsoft365IntegrationService } from '../../src/services/external-integration-systems/third-party-connectors/integration-orchestration/Microsoft365IntegrationService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('Microsoft365IntegrationService', () => {
  let service: Microsoft365IntegrationService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new Microsoft365IntegrationService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(Microsoft365IntegrationService);
    });
