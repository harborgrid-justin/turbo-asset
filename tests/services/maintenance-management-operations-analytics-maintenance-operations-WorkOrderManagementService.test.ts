import { WorkOrderManagementService } from '../../src/services/maintenance-management/operations-analytics/maintenance-operations/WorkOrderManagementService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('WorkOrderManagementService', () => {
  let service: WorkOrderManagementService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new WorkOrderManagementService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(WorkOrderManagementService);
    });
