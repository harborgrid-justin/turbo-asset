import { SpaceUtilizationService } from '../../src/services/space/SpaceUtilizationService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('SpaceUtilizationService', () => {
  let service: SpaceUtilizationService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(SpaceUtilizationService);
    });
