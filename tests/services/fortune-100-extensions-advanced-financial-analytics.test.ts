import { advancedFinancialAnalytics } from '../../src/services/fortune-100-extensions/advanced-financial-analytics';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('advancedFinancialAnalytics', () => {
  let service: advancedFinancialAnalytics;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new advancedFinancialAnalytics();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(advancedFinancialAnalytics);
    });
