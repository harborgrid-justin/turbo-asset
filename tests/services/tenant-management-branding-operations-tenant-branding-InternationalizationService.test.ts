import { InternationalizationService } from '../../src/services/tenant-management/branding-operations/tenant-branding/InternationalizationService';
...
describe('InternationalizationService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(InternationalizationService);
    });
