import { napiIntegration } from '../../src/services/napi-integration';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('napiIntegration', () => {
  let service: napiIntegration;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new napiIntegration();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(napiIntegration);
    });
