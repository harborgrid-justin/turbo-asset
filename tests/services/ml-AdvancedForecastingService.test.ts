import { AdvancedForecastingService } from '../../src/services/ml/AdvancedForecastingService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('AdvancedForecastingService', () => {
  let service: AdvancedForecastingService;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new AdvancedForecastingService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(AdvancedForecastingService);
    });
