import { DataGovernanceService } from '../../src/services/compliance-governance/regulatory-operations/compliance-management/DataGovernanceService';
...
describe('DataGovernanceService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(DataGovernanceService);
    });
