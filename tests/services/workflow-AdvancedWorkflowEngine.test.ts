import { AdvancedWorkflowEngine } from '../../src/services/workflow/AdvancedWorkflowEngine';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('AdvancedWorkflowEngine', () => {
  let service: AdvancedWorkflowEngine;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new AdvancedWorkflowEngine();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(AdvancedWorkflowEngine);
    });
