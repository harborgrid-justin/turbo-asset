import { CADIntegrationService } from '../../src/services/infrastructure-technology/smart-systems/infrastructure-operations/CADIntegrationService';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('CADIntegrationService', () => {
  let service: CADIntegrationService;
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(CADIntegrationService);
    });
