import { AssetValidationService } from '../../src/services/asset-management/maintenance-operations/asset-management/AssetValidationService';
...
describe('AssetValidationService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(AssetValidationService);
    });
