import { DocumentAnalyticsService } from '../../src/services/document-management/content-operations/document-lifecycle/DocumentAnalyticsService';
...
describe('DocumentAnalyticsService', () => {
  ...
  beforeEach(async () => {
    service = new DocumentAnalyticsService();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(DocumentAnalyticsService);
    });
