import { productionBusinessIntelligence } from '../../src/services/production-business-intelligence';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('productionBusinessIntelligence', () => {
  let service: productionBusinessIntelligence;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new productionBusinessIntelligence();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(productionBusinessIntelligence);
    });
