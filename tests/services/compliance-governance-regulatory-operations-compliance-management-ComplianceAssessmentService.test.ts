import { ComplianceAssessmentService } from '../../src/services/compliance-governance/regulatory-operations/compliance-management/ComplianceAssessmentService';
...
describe('ComplianceAssessmentService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(ComplianceAssessmentService);
    });
