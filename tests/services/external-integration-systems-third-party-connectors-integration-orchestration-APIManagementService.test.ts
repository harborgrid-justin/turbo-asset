import { APIManagementService } from '../../src/services/external-integration-systems/third-party-connectors/integration-orchestration/APIManagementService';
...
describe('APIManagementService', () => {
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(APIManagementService);
    });
