import { InfrastructureTypes } from '../../src/services/infrastructure-technology/smart-systems/infrastructure-operations/types/InfrastructureTypes';
import { createTestOrganization, createTestUser, testDb } from '../setup';

describe('InfrastructureTypes', () => {
  let service: InfrastructureTypes;
  let organizationId: string;
  let userId: string;

  beforeEach(async () => {
    service = new InfrastructureTypes();
  ...
  describe('Core Functionality', () => {
    it('should initialize service correctly', () => {
      ...
      expect(service).toBeInstanceOf(InfrastructureTypes);
    });
