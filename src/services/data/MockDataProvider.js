/**
 * Centralized Mock Data Provider (JavaScript version)
 * 
...
class MockDataProvider {
  constructor() {
    this.mockConfig = config.mockData;
  }
   ...
   */
  generateWorkOrders(assets, count) {
   ...
   */
  generateBIMaintenanceData(count) {
...
module.exports = { mockDataProvider, MockDataProvider };