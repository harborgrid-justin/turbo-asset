...
This is a [Next.js](https://nextjs.org) project that provides a user interface for managing various services.

## Features

- Dashboard with links to all service pages
- Individual UI pages for each service
- Built with Next.js, TypeScript, and Tailwind CSS

## Services Included

The application includes UI pages for the following services:
